...
public class JwtTokenProvider {
     ...
     */
    public String generateToken(final String userUuid, final LocalDateTime issuedDateTime, final LocalDateTime expiresDateTime) {

        final Date issuedAt = new Date(issuedDateTime.getLong(ChronoField.HOUR_OF_DAY));
        final Date expiresAt = new Date(expiresDateTime.getLong(ChronoField.HOUR_OF_DAY));
